...
- Runtime-sensitive `research` changes under `src/quantcraft/research/ta.py`, `src/quantcraft/research/adapters/execution_model.py`, `src/quantcraft/research/indicators/runtime/`, `src/quantcraft/research/indicators/pure/`, `src/quantcraft/research/application/backtest.py`, or `src/quantcraft/research/application/order_activation.py` should also run `uv run poe verify-runtime`.
