...
- Verification commands:
  - `uv run ruff check src/quantcraft/backtest/execution_model.py src/quantcraft/trading/domain/intents.py src/quantcraft/trading/domain/orders.py src/quantcraft/trading/domain/matching.py src/quantcraft/trading/order_requests.py src/quantcraft/trading/sizing.py src/quantcraft/research/strategy.py tests/support_backtest.py tests/integration/research/test_canonical_stop_limit_crosscheck_regression.py`
...
- Notes:
  ...
  - Stop-family classification is centralized in `quantcraft.trading.domain.intents._is_stop_order_type` and reused by production modules without adding a public domain export.
...
- Verification evidence:
  - `uv run ruff check src/quantcraft/backtest/execution_model.py src/quantcraft/backtest/strategy_runtime.py src/quantcraft/trading/domain/intents.py src/quantcraft/trading/domain/orders.py src/quantcraft/trading/domain/matching.py src/quantcraft/trading/order_requests.py src/quantcraft/trading/sizing.py src/quantcraft/research/strategy.py tests/support_backtest.py tests/integration/research/test_canonical_stop_limit_crosscheck_regression.py`: passed.
