...
| [`2026-07-09-validation-pipeline-architecture-research.md`](2026-07-09-validation-pipeline-architecture-research.md) | current | no | validation pipeline architecture, research subsystem reset, and evidence-generation DX | Before redesigning `quantcraft.research`, adding walk-forward/Monte Carlo/cost-sensitivity validation features, or defining validation pipeline interfaces. | Advisory source-review report comparing Freqtrade, vectorbt, NautilusTrader, backtesting.py, QuantStats, MLFinLab, Pyfolio, and Empyrical patterns for composable validation architecture. |
