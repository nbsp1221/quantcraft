...
- `from quantcraft.research import ParameterStudy, ta` works
- `from quantcraft.strategy import Strategy` works
- `ParameterStudy` is not promoted from `quantcraft.backtest`
- public docs use `quantcraft.strategy` for the canonical `Strategy` import
