...
| Stop-limit order planning | [`stop-limit.md`](stop-limit.md) | Governing | planned implementation scope | Before implementing or changing planned `stop_limit` strategy intake, trigger lifecycle, backtest execution semantics, or tests. |
