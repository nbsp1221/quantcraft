...
class _ReportBuilder:
    ...
    def build(
        ...
        *,
        ...
        active_return = round(total_return - buy_and_hold, 12) if buy_and_hold is not None else None
        ...
        return BacktestReport(
            ...
            exposure=ExposureMetrics(
                ...
                final_average_entry_price=(
                    final_state.average_entry_price if final_state.position_quantity > 0.0 else None
                ),
            ),
