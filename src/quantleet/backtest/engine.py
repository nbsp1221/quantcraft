...
class BacktestStrategyConstructionError(Exception):
...
def _materialize_strategy(
    *,
    ...
    try:
        ...
        raise BacktestStrategyConstructionError(strategy.__name__, error) from error
...
_BacktestStrategyConstructionError = BacktestStrategyConstructionError

__all__ = ["BacktestEngine", "BacktestStrategyConstructionError"]
